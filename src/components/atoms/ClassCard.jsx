 ...
 *
 * Props:
 *  cls {Object} – A class session object from the mock data generator:
 *    { id, name, teacher, timeString, colors, startHour, durationHours }
 */
const ClassCard = ({ cls }) => {
    return (
        <div
        ...
        >
            <div className={`h-full w-full rounded-lg border ${cls.colors} p-3 shadow-sm flex flex-col justify-between overflow-hidden group`}>
                ...
                <div className="flex items-center text-xs font-medium opacity-90 gap-1.5 mt-1 bg-white/40 dark:bg-black/20 rounded px-2 py-1 w-max">
