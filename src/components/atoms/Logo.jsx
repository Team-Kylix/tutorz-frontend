...
const Logo = ({ size = 'large', className = '' }) => {
    ...
    // 1. Sidebar Variant (Small, Flex Row)
    if (size === 'small') {
        return (
            <div className={`flex items-center gap-2 font-bold text-xl text-blue-700 dark:text-blue-400 tracking-wide ${className}`}>
                <img 
                    src={logoIcon} 
                    alt="Tutorz" 
                    className="h-8 w-8" 
    ...
    // 2. Auth Page Variant (Large, Centered, Subtitle)
    return (
