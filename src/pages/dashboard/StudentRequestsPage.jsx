...
import {
    Check, X, Loader2, Search, Filter,
    RefreshCw, AlertCircle, Clock, Trash2, GraduationCap
} from 'lucide-react';
                            ...
                            <tbody className="divide-y divide-gray-100 dark:divide-gray-700/50">
                                {filteredRequests.map((req) => {
                                    const initials = req.name
                                        ? req.name.split(' ').map(n => n.charAt(0)).join('').toUpperCase().slice(0, 2)
                                        : '';
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    <StudentAvatar
                                                        ...
                                                        imageUrlLarge={req.profileImageUrlLarge}
                                                        initials={initials}
                                                    />
                                                    <div>
